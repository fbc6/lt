...
<link rel="stylesheet" href="template/banzhuan_freewap/touch/common/style.css" type="text/css" media="all">
<script src="template/banzhuan_freewap/touch/common/jquery.min.js?{VERHASH}"></script>
